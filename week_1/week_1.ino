...
void setup() {
  ...
  servo_0.attach(9);  // Attach servo to pin 9
  servo_1.attach(10); // Attach servo to pin 10
  servo_2.attach(11); // Attach servo to pin 11
  servo_3.attach(12); // Attach servo to pin 12
  Serial.begin(115200);
